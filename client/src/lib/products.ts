/*
 * SKINPECCABLE GLOWTIQUE — Product Catalog
 * Auto-generated from Odoo product upload
 * 228 products across 18 categories
 * 
 * CHANGES FROM PREVIOUS VERSION:
 * - price type updated to number | 'SOLD OUT' 
 * - 43 products with no sales price set to 'SOLD OUT'
 * - 27 products that previously had price:0 now have correct prices from updated Odoo sheet
 * - product_167 price corrected from 1883.903 to 1884
 */
...
export interface Product {
  ...
  brand: string;
  category: string;
  // ── price is now number | 'SOLD OUT'
  // Use isSoldOut(product) helper below before adding to cart or showing price.
...
// ── Helper: type-safe sold-out check usable anywhere in the codebase
...
export const CATEGORIES = [
  ...
  { id: 'body-hair-mist', label: 'Body & Hair Mist' },
  { id: 'body-lotion-butter-cream', label: 'Body Lotion, Butter & Cream' },
  { id: 'body-wash', label: 'Body Wash' },
  { id: 'candle', label: 'Candle' },
  { id: 'cleanser', label: 'Cleanser' },
  { id: 'deodorant', label: 'Deodorant' },
  { id: 'face-cream-moisturizer', label: 'Face Cream & Moisturizer' },
  { id: 'fragrance-cologne-edp', label: 'Fragrance, Cologne & EDP' },
  { id: 'general-skincare-beauty', label: 'General Skincare & Beauty' },
  { id: 'gift-sets-bundles', label: 'Gift Sets & Bundles' },
  { id: 'home-fragrance', label: 'Home Fragrance' },
  { id: 'lip-care', label: 'Lip Care' },
  { id: 'makeup', label: 'Makeup' },
  { id: 'mask', label: 'Mask' },
  { id: 'minis', label: 'Minis' },
  { id: 'serum-toner-essence', label: 'Serum / Toner / Essence' },
...
export const PRODUCTS: Product[] = [
  {
    id: 'skinpeccable_product_001',
    name: 'NIVEA Japan - UV Super Water Gel SPF50 PA+++ - 140g',
    brand: 'NIVEA Japan',
    category: 'sunscreen',
    price: 2700,
  ...
  },
  {
    ...
    name: 'Mary&May - CICA Soothing Sun Cream SPF50+ PA++++ - 50ml',
    brand: 'Mary&May',
    category: 'sunscreen',
    price: 2300,
  ...
  },
  {
    ...
    name: 'Kose - Softymo - Speedy Cleansing Oil - 230ML',
    brand: 'Kose',
    category: 'cleanser',
    price: 1800,
  ...
  },
  {
    ...
    name: 'Etude House - Soon Jung 5.5 Foam Cleanser - 150ML - 150ml',
    brand: 'Etude House',
    category: 'cleanser',
    price: 2000,
  ...
  },
  {
    ...
    name: 'BEAUTY OF JOSEON - Centella Asiatica Calming Mask - 10pcs',
  ...
  },
  {
    ...
    name: 'Haruharu WONDER - Black Rice Moisture Airyfit Daily Sunscreen SPF50+ PA++++ - 50ml',
    brand: 'Haruharu WONDER',
    category: 'sunscreen',
    price: 2300,
  ...
  },
  {
    ...
    name: 'Haruharu WONDER - Black Rice Hyaluronic Toner - Fragrance Free - 150ml (2ea) Set',
    brand: 'Haruharu WONDER',
  ...
  },
  {
    ...
    name: 'SCINIC - Enjoy Super Active Airy Sun Stick SPF50+ PA++++ - 15g',
    brand: 'SCINIC',
    category: 'sunscreen',
    price: 1500,
  ...
  },
  {
    ...
    name: 'Kao - Biore UV Aqua Rich Watery Essence SPF50+ PA++++ - 70g',
    brand: 'Kao',
    category: 'sunscreen',
    price: 2300,
  ...
  },
  {
    ...
    name: 'Kao - Biore UV Aqua Rich Light Up Essence SPF 50+ PA++++ (Japan Version) - 70g',
    brand: 'Kao',
    category: 'sunscreen',
    price: 2300,
  ...
  },
  {
    ...
    name: 'SCINIC - Enjoy Super Mild Sun Essence SPF50+ PA++++ - 50ml',
    brand: 'SCINIC',
    category: 'sunscreen',
    price: 1200,
  ...
  },
  {
    ...
    name: 'MIX: BAR Sparkling Hibiscus Hair and Body Mist',
    brand: 'Skinpeccable',
  ...
  },
  {
    ...
    name: 'MIX: BAR Whipped Almond  Hair and Body Mist',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 2500,
  ...
  },
  {
    ...
    name: 'MIX: BAR Vanilla Bourbon Hair and Body Mist (mini )',
    brand: 'Skinpeccable',
    category: 'minis',
    price: 1200,
  ...
  },
  {
    ...
    name: 'MIX:BARWhipped Almond  Hair and Body Eau De Parfum',
    brand: 'Skinpeccable',
  ...
  },
  {
    ...
    name: 'Finer\'ry Body Mist Fragrance Magnetic Candy',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 2500,
  ...
  },
  {
    ...
    name: 'Finer\'ry Body Mist Fragrance Sun Phoria',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 2500,
  ...
  },
  {
    ...
    name: 'Finer\'ry Body Mist Fragrance Perfume Set (5pc)',
    brand: 'Skinpeccable',
    category: 'gift-sets-bundles',
    price: 4000,
  ...
  },
  {
    ...
    name: 'Fresh Coconut & Cotton Fine Fragrance Mist',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 2000,
  ...
  },
  {
    ...
    name: 'Mens Smoked Old Fashioned Cologne',
    brand: 'Skinpeccable',
    category: 'fragrance-cologne-edp',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Sun-Ripened Raspberry Fine Fragrance Mist',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Indigo Dreams Fine Fragrance Mist',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Fresh Jungle Rain Fine Fragrance Mist',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'White Tea & Ginger Fine Fragrance Mist',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Waikiki Beach Coconut Fine Fragrance Mist',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Juniper Breeze Fine Fragrance Mist',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Amethyst Waves Fine Fragrance Mist',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Sea Island Shore Fine Fragrance Mist',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Sweet Petal Pound Cake Fine Fragrance Mist',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Emerald Mist Fine Fragrance Mist',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Mens Teakwood 3-in-1 Hair, Face & Body Wash',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Mens Bourbon 3-in-1 Hair, Face & Body Wash',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Mens Smoked Old Fashioned 3-in-1 Hair, Face & Body Wash',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Hello to us Signature Single Wick Candle',
    brand: 'Skinpeccable',
    category: 'candle',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Coco Paradise Signature Single Wick Candle',
    brand: 'Skinpeccable',
    category: 'candle',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Dark Amber & Oud Signature Single Wick Candle',
    brand: 'Skinpeccable',
    category: 'candle',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Endless Weekend Signature Single Wick Candle',
    brand: 'Skinpeccable',
    category: 'candle',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Fresh Coconut & Cotton Signature Single Wick Candle',
    brand: 'Skinpeccable',
    category: 'candle',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Rose Water & Ivy & Mahogany Teakwood 3-Wick Candle',
    brand: 'Skinpeccable',
    category: 'candle',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Among The Clouds Car Fragrance Refill',
    brand: 'Skinpeccable',
  ...
  },
  {
    ...
    name: 'Tiki Beach Wallflowers Fragrance Refills, 2-Pack',
    brand: 'Skinpeccable',
    category: 'home-fragrance',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Holy Hydration! e.l.f. Off Makeup Remover',
    brand: 'Skinpeccable',
  ...
  },
  {
    ...
    brand: 'Holy Hydration! Face Cream',
    category: 'face-cream-moisturizer',
    price: 2600,
  ...
  },
  {
    ...
    name: 'Pure Skin Back to Basics Mini Kit',
    brand: 'Skinpeccable',
    category: 'gift-sets-bundles',
    price: 3000,
  ...
  },
  {
    ...
    name: 'SuperHydrate Gel Moisturizer',
    brand: 'Skinpeccable',
    category: 'face-cream-moisturizer',
    price: 2600,
  ...
  },
  {
    ...
    name: 'Holy Hydration! Hydro-Gel Moisturizer',
    brand: 'Skinpeccable',
    category: 'face-cream-moisturizer',
    price: 2600,
  ...
  },
  {
    ...
    name: 'Professional Set of 12 Makeup Brushes',
    brand: 'Skinpeccable',
    category: 'makeup',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'No Budge Retractable Eyeliner',
    brand: 'Skinpeccable',
    category: 'makeup',
    price: 1300,
  ...
  },
  {
    ...
    name: 'Big Mood Mascara Travel Size',
    brand: 'Skinpeccable',
    category: 'minis',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Suntouchable! Invisible Sunscreen SPF 35 Mini',
    brand: 'Skinpeccable',
    category: 'minis',
    price: 500,
  ...
  },
  {
    ...
    name: 'Holy Hydration! The Essentials Mini Kit',
    brand: 'Skinpeccable',
    category: 'gift-sets-bundles',
    price: 3000,
  ...
  },
  {
    ...
    name: 'The Niacinamide Gels Bundle',
    brand: 'Skinpeccable',
    category: 'gift-sets-bundles',
    price: 6500,
  ...
  },
  {
    ...
    name: 'Fragrance free Hydrating tinted SPF',
    brand: 'Skinpeccable',
    category: 'sunscreen',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Pacific Cypress Body wash',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 2300,
  ...
  },
  {
    ...
    name: 'Sweet Peach $ Nectar lotion',
    brand: 'Skinpeccable',
  ...
  },
  {
    ...
    name: 'Sweet peach $ nectar deo spray',
    brand: 'Skinpeccable',
    category: 'deodorant',
    price: 3500,
  ...
  },
  {
    ...
    name: 'coconut $ vanilla deo spray',
    brand: 'Skinpeccable',
    category: 'deodorant',
    price: 3500,
  ...
  },
  {
    ...
    name: 'coconut caramel deo stick',
    brand: 'Skinpeccable',
    category: 'deodorant',
    price: 2600,
  ...
  },
  {
    ...
    name: 'Finer\'y Sweet on the outside',
    brand: 'Skinpeccable',
    category: 'general-skincare-beauty',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Finery Before the Rainbow',
    brand: 'Skinpeccable',
    category: 'general-skincare-beauty',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Being Frenshe Mist Solar Fluer',
    brand: 'Skinpeccable',
    category: 'general-skincare-beauty',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Coconut and Vanilla hand whole body deo cream',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Magnolia Violet Body Mist',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Cheerful Charmer Body Mist',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Hand + Body Lotion Variety Bundle',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Mandarin Vetiver / Standard',
    brand: 'Skinpeccable',
    category: 'general-skincare-beauty',
    price: 2700,
  ...
  },
  {
    ...
    name: '3-in-1 All Over Wash Sea Salt / Litre',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 4000,
  ...
  },
  {
    ...
    name: 'Cold Plunge Bar Soap Tahoe Blue',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 1200,
  ...
  },
  {
    ...
    name: 'PanOxyl Acne C4% Benzoyl Peroxide,',
    brand: 'Skinpeccable',
    category: 'general-skincare-beauty',
    price: 2800,
  ...
  },
  {
    ...
    name: 'Body Fantasies Signature Fragrance  Gift Set',
    brand: 'Skinpeccable',
    category: 'gift-sets-bundles',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Dove Invigorating  Aloe & Eucalyptus Body Wash',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 4000,
  ...
  },
  {
    ...
    name: 'Dove Renewing Peony and Rose Oil Body Wash',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 4000,
  ...
  },
  {
    ...
    name: 'Summer®s Eve Fragrance Free',
    brand: 'Skinpeccable',
    category: 'general-skincare-beauty',
    price: 2200,
  ...
  },
  {
    ...
    name: 'Dove Pampering Shea Butter & Vanilla Body Wash',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 4000,
  ...
  },
  {
    ...
    name: 'Carmex  Minis Lip Balm Tubes, SPF 15,  5 Pack',
    brand: 'Skinpeccable',
    category: 'minis',
    price: 2100,
  ...
  },
  {
    ...
    name: 'Dove Restoring Coconut & Cocoa Butter',
    brand: 'Skinpeccable',
    category: 'general-skincare-beauty',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Dove Rejuvenating  Pomegranate and Hibiscus',
    brand: 'Skinpeccable',
    category: 'general-skincare-beauty',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Body by TPH Indulge Me Seductive',
    brand: 'Skinpeccable',
    category: 'general-skincare-beauty',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Summer®s Eve Simply Sensitive',
    brand: 'Skinpeccable',
    category: 'general-skincare-beauty',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'iUNIK - Beta-Glucan Daily Moisture Cream 60m',
    brand: 'iUNIK',
    category: 'face-cream-moisturizer',
    price: 2200,
  ...
  },
  {
    ...
    name: 'Cos De BAHA - RS Retinol 2.5 Serum Jumbo',
    brand: 'Cos De BAHA',
    category: 'serum-toner-essence',
    price: 2000,
  ...
  },
  {
    ...
    name: 'haruharu wonder - Black Rice Moisture 5.5 Soft Cleansing Gel',
    brand: 'haruharu wonder',
    category: 'cleanser',
    price: 1700,
  ...
  },
  {
    ...
    name: 'haruharu wonder - Black Rice Hyaluronic Toner Fragrance Free Jumbo',
    brand: 'haruharu wonder',
    category: 'serum-toner-essence',
    price: 2800,
  ...
  },
  {
    ...
    name: 'APLB - Retinol Vitamin C Vitamin E Facial Cream',
    brand: 'APLB',
    category: 'face-cream-moisturizer',
    price: 1450,
  ...
  },
  {
    ...
    name: 'APLB - Hyaluronic Acid Ceramide HA B5 Facial Cream',
    brand: 'APLB',
    category: 'face-cream-moisturizer',
    price: 1450,
  ...
  },
  {
    ...
    name: 'APLB - Glutathione Niacinamide Sunscreen',
    brand: 'APLB',
    category: 'sunscreen',
    price: 1500,
  ...
  },
  {
    ...
    name: 'APLB - Urea Hyaluronic Acid Facial Cream',
    brand: 'APLB',
    category: 'face-cream-moisturizer',
    price: 1400,
  ...
  },
  {
    ...
    name: 'APLB - Tranexamic Acid Niacinamide Ampoule Serum',
    brand: 'APLB',
    category: 'serum-toner-essence',
    price: 1400,
  ...
  },
  {
    ...
    name: 'Kose - Suncut UV Perfect Essence SPF 50+ PA++++',
    brand: 'Kose',
    category: 'sunscreen',
    price: 2200,
  ...
  },
  {
    ...
    name: 'Vanilla Cashmere Body Lotion',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Lip Oil Balm Viral Bundle',
    brand: 'Skinpeccable',
    category: 'lip-care',
    price: 1884,
  ...
  },
  {
    ...
    name: 'Sensitive Skin Shave Cream',
    brand: 'Skinpeccable',
    category: 'shave',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Vintage Suede Antiperspirant & Deodorant',
    brand: 'Skinpeccable',
    category: 'deodorant',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Italian Bergamot Body Wash',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 3200,
  ...
  },
  {
    ...
    name: 'Cedarwood hand and body lotion',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Seasalt Hand and body lotion',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Sandalwood hand and body lotion',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Pomegranate Raspberry Body Lotion',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 3200,
  ...
  },
  {
    ...
    name: 'Vanilla Cashmere Body Wash',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 3200,
  ...
  },
  {
    ...
    name: 'SPF 50 fragrance free Sunscreen 75ml',
    brand: 'Skinpeccable',
    category: 'sunscreen',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'SPF50 Fragrance free Sunscreen 150 ml',
    brand: 'Skinpeccable',
    category: 'sunscreen',
    price: 'SOLD OUT',
  ...
  },
  {
    ...
    name: 'Walmart Tahitian Vanilla whipped body butter',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 2500,
  ...
  },
  {
    ...
    name: 'Eos Shea Butter Vanilla Cashmere bodybutter',
    brand: 'Skinpeccable',
    category: 'general-skincare-beauty',
    price: 3200,
  ...
  },
  {
    ...
    name: 'Thirst Quencher lip oil collection',
    brand: 'Skinpeccable',
    category: 'lip-care',
    price: 2600,
  ...
  },
  {
    ...
    name: 'Salted Sunset Lotion and Mist Duo',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 8000,
  ...
  },
  {
    ...
    name: 'Solar Muse Mini Hair $ Body Mist',
    brand: 'Skinpeccable',
    category: 'minis',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Love letter Mini Hair & Body Mist',
    brand: 'Skinpeccable',
    category: 'minis',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Golden Vanilla Hair $ Body Mist',
    brand: 'Skinpeccable',
    category: 'minis',
    price: 3000,
  ...
  },
  {
    ...
    name: 'Not that Vanilla Mini Body Mist',
    brand: 'Skinpeccable',
    category: 'minis',
    price: 1500,
  ...
  },
  {
    ...
    name: 'Coffee Cloud Mini Body Mist',
    brand: 'Skinpeccable',
    category: 'minis',
    price: 1500,
  ...
  },
  {
    ...
    name: 'Coco Blush  Mini Body Mist',
    brand: 'Skinpeccable',
    category: 'minis',
    price: 1500,
  ...
  },
  {
    ...
    name: 'Sugar Berry Mini Body Mist',
    brand: 'Skinpeccable',
    category: 'minis',
    price: 1500,
  ...
  },
  {
    ...
    name: 'Holler And Glow Miami Wave Salted Caramel Body & Hair Mist,',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 1700,
  ...
  },
  {
    ...
    name: 'Bodycology Sparkle Fragrance Shimmer Mist, Whipped Vanilla, 6',
    brand: 'Skinpeccable',
    category: 'body-hair-mist',
    price: 1700,
  ...
  },
  {
    ...
    name: 'Vaseline Glazed and Glisten Golden Hour Glow Vanilla Cocoa',
    brand: 'Skinpeccable',
    category: 'general-skincare-beauty',
    price: 2600,
  ...
  },
  {
    ...
    name: 'Vaseline Glazed & Glisten Sunlit Glow Vanilla Cocoa Shimmering',
    brand: 'Skinpeccable',
    category: 'general-skincare-beauty',
    price: 2600,
  ...
  },
  {
    ...
    name: ' Equate Moisture Care Cocoa Divine Body Oil Gel, 6.8 fl oz',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 2000,
  ...
  },
  {
    ...
    name: 'MIX:BAR Coconut Palm Body Wash with Vitamin E, 16fl oz',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 2900,
  ...
  },
  {
    ...
    name: 'MIX:BAR Coconut Palm Moisturizing Body Cream with',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 3100,
  ...
  },
  {
    ...
    name: 'Holler and Glow Miami Wave Salted Caramel Body Butter,',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 1700,
  ...
  },
  {
    ...
    name: 'Holler and Glow Hawaii Heat Vanilla Body Butter, 150g/5.29 oz',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 1700,
  ...
  },
  {
    ...
    name: 'MIX:BAR Sparkling Hibiscus Body Wash with Vitamin E, 16fl oz',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 2900,
  ...
  },
  {
    ...
    name: 'MIX:BAR Whipped Almond Moisturizing Body Cream with',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 3100,
  ...
  },
  {
    ...
    name: 'MIX:BAR Whipped Almond Body Wash',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 2900,
  ...
  },
  {
    ...
    name: 'MIX:BAR Vanilla Bourbon Moisturizing Body Cream with',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 3100,
  ...
  },
  {
    ...
    name: 'MIX:BAR Vanilla Bourbon Body Wash with Vitamin E and',
    brand: 'Skinpeccable',
    category: 'body-wash',
    price: 2900,
  ...
  },
  {
    ...
    name: 'Nourishing Body Butter, Coconut Hibiscus, 11 oz',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 2500,
  ...
  },
  {
    ...
    name: 'Nourishing Whipped Body Butter, Tahitian Vanilla, 11 oz',
    brand: 'Skinpeccable',
    category: 'body-lotion-butter-cream',
    price: 2500,
