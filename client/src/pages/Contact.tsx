...
export default function Contact() {
  ...
  return (
    <div>
      ...
      <section className="pb-24" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            >
              <div className="absolute -top-12 -right-12 w-48 h-48 rounded-full opacity-10" style={{ backgroundColor: '#25D366' }} />
              <div className="absolute -bottom-8 -left-8 w-32 h-32 rounded-full opacity-5" style={{ backgroundColor: 'var(--deep-orange)' }} />

              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-6" style={{ backgroundColor: '#25D366' }}>
              ...
              <div>
                <p className="font-body font-medium uppercase tracking-widest mb-2" style={{ fontSize: '0.65rem', color: 'rgba(234,223,207,0.5)', letterSpacing: '0.18em' }}>
                  Fastest Response
                </p>
                <h3 className="font-display font-semibold mb-2" style={{ fontSize: '1.5rem', color: '#FFFFFF' }}>
                  Chat on WhatsApp
                </h3>
                <p className="font-body" style={{ fontSize: '0.875rem', color: 'rgba(234,223,207,0.65)', lineHeight: 1.6 }}>
                  Quick replies, product help & order support. We typically respond within minutes.
                </p>
              </div>

              <div className="mt-6 inline-flex items-center gap-2 font-body font-semibold text-sm" style={{ color: '#25D366' }}>
                +254 722 303 056 <span>→</span>
              </div>
            </a>

            {/* Instagram */}
            <a
              href="https://instagram.com/skinpeccable.ke"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              <div className="absolute -top-10 -right-10 w-40 h-40 rounded-full opacity-20" style={{ backgroundColor: '#FFFFFF' }} />

              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-6" style={{ backgroundColor: 'rgba(255,255,255,0.25)' }}>
                <Instagram size={26} color="white" />
              </div>

              <div>
                <p className="font-body font-medium uppercase tracking-widest mb-2" style={{ fontSize: '0.65rem', color: 'rgba(255,255,255,0.6)', letterSpacing: '0.18em' }}>
                  Stay Connected
                </p>
                <h3 className="font-display font-semibold mb-2" style={{ fontSize: '1.5rem', color: '#FFFFFF' }}>
                  Follow Us
                </h3>
                <p className="font-body" style={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.75)', lineHeight: 1.6 }}>
                  New arrivals, skincare tips, and behind-the-scenes content. DM us anytime.
                </p>
              </div>

              <div className="mt-6 inline-flex items-center gap-2 font-body font-semibold text-sm" style={{ color: '#FFFFFF' }}>
                @skinpeccable.ke <span>→</span>
              </div>
            </a>
            ...
            <a
              ...
              style={{
                background: 'linear-gradient(135deg, #010101 0%, #1a1a2e 50%, #010101 100%)',
                padding: '2.5rem',
                minHeight: '260px',
                textDecoration: 'none',
                transition: 'transform 0.3s ease, box-shadow 0.3s ease',
              ...
              onMouseEnter={e => {
                (e.currentTarget as HTMLAnchorElement).style.transform = 'translateY(-4px)';
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 20px 48px rgba(0,0,0,0.35)';
              }}
              onMouseLeave={e => {
                (e.currentTarget as HTMLAnchorElement).style.transform = 'translateY(0)';
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = 'none';
            ...
            >
              <div className="absolute -top-10 -right-10 w-40 h-40 rounded-full opacity-10" style={{ backgroundColor: '#69C9D0' }} />

              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-6" style={{ backgroundColor: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.15)' }}>
                <svg width="26" height="26" viewBox="0 0 24 24" fill="white">
              ...
              <div>
                <p className="font-body font-medium uppercase tracking-widest mb-2" style={{ fontSize: '0.65rem', color: 'rgba(255,255,255,0.5)', letterSpacing: '0.18em' }}>
                  Watch & Follow
                </p>
                <h3 className="font-display font-semibold mb-2" style={{ fontSize: '1.5rem', color: '#FFFFFF' }}>
                  Find Us on TikTok
                ...
                <p className="font-body" style={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.6)', lineHeight: 1.6 }}>
                  Product demos, skincare routines, and behind-the-scenes moments. Follow along.
                </p>
              </div>

              <div className="mt-6 inline-flex items-center gap-2 font-body font-semibold text-sm" style={{ color: '#69C9D0' }}>
                @skinpeccable.ke <span>→</span>
              </div>
            </a>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            >
              <div className="w-11 h-11 rounded-xl flex items-center justify-center" style={{ backgroundColor: 'var(--deep-orange)' }}>
                <Mail size={18} color="white" />
              </div>
              <div>
                <p className="font-body font-medium uppercase tracking-widest mb-1" style={{ fontSize: '0.6rem', color: 'var(--warm-taupe)', letterSpacing: '0.15em' }}>
                  Email Us
                </p>
                <p className="font-body font-semibold" style={{ fontSize: '0.875rem', color: 'var(--dark-chocolate)', lineHeight: 1.4 }}>
      ...
      <section className="py-16 text-center" style={{ backgroundColor: 'var(--dark-chocolate)' }}>
        <div className="container reveal">
          <p className="font-display italic text-xl mb-2" style={{ color: 'var(--deep-orange)' }}>
            Glow. Different.
          </p>
          <p className="font-body" style={{ fontSize: '0.9rem', color: 'rgba(234,223,207,0.65)' }}>
